...
const restaurant = {
  ...
  orderPasta(ing1, ing2, ing3) {
    console.log(`Here is yout delicious pasta with ${ing1}, ${ing2} and ${ing3}`);
  },
...
// capitalizeName('jose luis espiritu');
...
// console.log(maskCreditCard(4333755));
// console.log(maskCreditCard(433375512312147));
// console.log(maskCreditCard('15646548748674879'));
...
// // 2) Delete Yellow Card 64 from map
// gameEvents.delete(64);
// console.log(gameEvents);

// // 3) print to the console the average of the game
// console.log(`An event happend, on avergae, every ${90 /gameEvents.size} minutes`);

// const time = [...gameEvents.keys()].pop();
// console.log(time);
// console.log(`An event happend, on avergae, every ${time /gameEvents.size} minutes`);


// // 4) Loop over events FIRST HALF, SECOND HALF
...
// // Real-world example
// const ingredients = [
// /*   prompt('Let\'s made pasta! Ingredient 1?:'),
// prompt('Ingredient 2?'),
// prompt('Ingredient 3?') */
// ];
